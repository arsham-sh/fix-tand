            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                        ...
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">خانه</small>
                    </h1>
                    <!-- end Title -->
                </div>
                <!-- end Page title -->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">286 نفر</div>
                                <div class="fw-bold text-gray-400">تعداد مشتری ها</div>
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">782 محصول</div>
                                <div class="fw-bold text-gray-100">تعداد محصولات</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">12 سفارش</div>
                                <div class="fw-bold text-white">سفارشات</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">3 ادمین</div>
                                <div class="fw-bold text-white">ادمین ها</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">لیست ادمین ها</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">2 ادمین</span>
                                </h3>
                                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-trigger="hover" title="برای اضافه کردن ادمین کلیک کنید">
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                        ...
                                        <thead>
                                            <tr class="fw-bolder text-muted">
                                                ...
                                                <th class="min-w-150px">مشخصات</th>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                class="text-dark fw-bolder text-hover-primary fs-6">آرشام
                                                                شعبانی</a>
                                                            <span class="text-muted fw-bold text-muted d-block fs-7">مالک
                                                                مغازه</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="text-dark fw-bolder fs-6">arsham-sh</span>
                                                </td>
                                                <td>
                                                    <span class="text-dark fw-bold fs-6">09114146058</span>
                                                </td>
                                                <td>
