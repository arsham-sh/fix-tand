...
<main class="w-full max-w-sm bg-white rounded-2xl p-8 md:p-10">
    ...
    <section class="text-center mb-6">
        <h1 class="text-2xl font-DanaBlack text-black">ثبت نام</h1>
        <p class="text-gray-700 text-sm mt-2 font-DanaBold">فرم زیر را برای ساخت حساب پر کنید</p>
    </section>
    ...
    <p class="text-center text-gray-700 text-sm mt-8 font-DanaMediume">
        حساب کاربری داری؟
        <a href="{{ route('login') }}" class="text-original-red font-DanaBold hover:underline">ایجاد حساب</a>
    </p>
</main>
@endsection